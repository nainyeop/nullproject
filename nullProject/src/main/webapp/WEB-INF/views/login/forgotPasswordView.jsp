...
<h1>비밀번호 찾기</h1>
		<div class="login-all">
			...
			<div class="login-nav">
				<form action="./forgotTwoCtr.do" method="post">
					<table class="login-table">
						<tr>
							<td style="background: #D5D5D5;">비밀번호</td>
							<td><input type="text" name='memberPassword' value='${memberDto.memberPassword}' readonly="readonly"></td>
						</tr>
						
						<tr>
							<td colspan="2"><button type='button' value='확인'
									onclick="pageMoveDeleteFnc();">확인</button></td>
						</tr>
